    ...
    public partial class ManuallyReversePage
    {
        ...
        public void TranslatePage()
        {
            if (GlobalConfig.Chinese)
            {
                ...
                TextBox_IBBufFilePath.Header = "IndexBuffer文件路径:";
                ...
                TextBox_CategoryBufferFilePath.Header = "分类Buffer文件路径:";
            ...
            else
            {
                ...
                TextBox_IBBufFilePath.Text = "IndexBuffer File Path:";
                ...
                TextBox_CategoryBufferFilePath.Header = "CategoryBuffer File Path:";
