    ...
    public partial class WorkPage
    {
        ...
        public void TranslatePage()
        {
            if (GlobalConfig.Chinese)
            {
                ...
                Button_OpenWorkSpaceGeneratedModFolder.Content = "打开当前生成Mod的文件夹";
                ...
                Menu_ToolBox_CleanAllFrameAnalysisFolder.Text = "清除当前游戏所有的FrameAnalysis文件夹";
                Menu_ToolBox_CleanFrameAnalysisFolderButKeepLatest.Text = "清除当前游戏的FrameAnalysis文件夹，但保留最新的";
            ...
            else
            {
                ...
                Button_OpenWorkSpaceGeneratedModFolder.Content = "Open Current Generated Mod Folder";
                ...
                Menu_ToolBox_CleanAllFrameAnalysisFolder.Text = "Clean All FrameAnalysis Folders For Current Game";
                Menu_ToolBox_CleanFrameAnalysisFolderButKeepLatest.Text = "Clean FrameAnalysis Folders For Current Game But Keep The Latest One";
            }
        }
